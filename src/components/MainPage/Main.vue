...
const active = ref('0');
const data = ref(Object.values(questions));
...
<template>
    ...
    <div class="info_block">
      <div class="info_block__top">
        ...
        <div class="info_block__text">
          ...
          <p class="info_block__description">Category В</p>
        </div>
      ...
      <div class="info_block__bottom">
        <p class="info_block__bottom_text">{{ data.filter(q => q.answered === true).length }} questions out of
          {{ data.length }} passed</p>
        <ProgressBar/>
      </div>
    </div>
    ...
    <div class="buttons_block">
      <Button text="Mistakes" :img="Pen"/>
      <Button text="Statistics" :img="Chart"/>
      <Button text="Highway Code" :img="Book"/>
      <Button text="Favorites" :img="Bookmark"/>
    </div>
